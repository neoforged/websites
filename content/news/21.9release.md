...
date: 2025-09-30T19:20:00+02:00
categories:
- News
- Releases
...
- `createRenderState`: creates a new instance of the render state. The render state should be a mutable object and will be reused.
...
Now, a render state class is now needed:
```java
