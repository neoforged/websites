...
<!-- As you can see, there is now a generic `IResourceHandler<T>` interface, to transfer resources of type `T`.
To transfer items, `ItemResource` is used. To transfer fluids, `FluidResource` is used. -->
